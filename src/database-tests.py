...
# local testing to check if the database classes are correctly executed
if __name__ == '__main__':
    ...
    create_user = db_instance.create_user('testtest', 'test@gmail.com', 'testtest')
    user = db_instance.get_user_by_name('cristina17')
    print(trip_create.trip_create('name2', user.id, 20, 'true', 'true', 500))
    print(trips_inst.trips_list(user.id))
    print(attraction_list.get_attractions_from_trip(1))
